...
+----------+------------+------------------------------------+
|        2 | 0.22574625 | ALTER TABLE orders ENGINE = MyISAM |
|        3 | 0.23245700 | ALTER TABLE orders ENGINE = InnoDB |
+----------+------------+------------------------------------+
...
Решение:
```
vagrant@vagrant:~$ sudo cat /var/lib/docker/volumes/vol_mysql/_data/my.cnf
